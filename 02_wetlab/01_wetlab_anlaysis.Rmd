...
---
This document consist of codes for analysis and visualisation of lab data from growth assays, hplc measurement of individual and mixed cultures of Db-MM. 
...
hplc_data <- read.csv("data/mono_culture_hplc.csv", 
...
```{r}
## Since acetate was added in the media and had high concentration, I will plot it seperately 
...
p.ace
ggsave("output/figs/01_mono_culture_HPLC_Acetate.pdf", height = 5, width = 10)
...
ggsave("output/figs/01_mono_culture_HPLC_metabolites.pdf", height = 5, width = 14)
...
ggsave("output/figs/Edit_01_mono_cultue_HPLC_metabolites.pdf", height = 9, width = 16)
...
mixed_data <- read.csv("data/mixed_culture_scfa_gc.csv", 
                      row.names = 1, header = T, 
                      stringsAsFactors = F)
...
ggsave("output/figs/01_Figure_Mixed_HPLC.pdf", height = 3, width = 6)
ggsave("output/figs/01_Figure_Mixed_HPLC.png", height = 3, width = 6)
ggsave("output/figs/01_Figure_Mixed_HPLC.tiff", height = 3, width = 6)
...
od_metadata <- read.csv("./data/mixed_culture_od_ph.csv", 
                      row.names = 1, header = T, 
                      stringsAsFactors = F)
...
ggsave("output/figs/01_mixed_culture_OD_PH_figure.pdf", height = 3, width = 6)
ggsave("output/figs/01_mixed_culture_OD_PH_figure.png", height = 3, width = 6)
ggsave("output/figs/01_mixed_culture_OD_PH_figure.tiff", height = 3, width = 6)
```
...
ph_data <- read.csv("./data/mono_culture_od_ph.csv", 
                      row.names = 1, header = T, 
                      stringsAsFactors = F)
...
ggsave("output/figs/01_mono_culture_OD_PH.pdf", height = 4, width = 10)

ggsave("output/figs/01_mono_culture_OD_PH.tiff", height = 4, width = 10)
